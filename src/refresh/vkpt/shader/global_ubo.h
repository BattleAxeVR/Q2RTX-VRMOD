...
#define GLOBAL_UBO_VAR_LIST \
	...
	GLOBAL_UBO_VAR_LIST_DO(vec4,            cam_pos_left) \
	GLOBAL_UBO_VAR_LIST_DO(vec4,            cam_pos_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            V_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            V_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            invV_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            invV_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            V_prev_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            V_prev_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            P_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            P_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            invP_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            invP_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            P_prev_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            P_prev_right) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            invP_prev_left) \
	GLOBAL_UBO_VAR_LIST_DO(mat4,            invP_prev_right) \
