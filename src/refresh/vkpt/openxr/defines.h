...
#define FLIP_FOV_LEFT_RIGHT_FOR_OPENXR 0//USE_EULER_ANGLES_FOR_XR_VIEW 
#define FLIP_FOV_UP_DOWN_FOR_OPENXR 1//!USE_EULER_ANGLES_FOR_XR_VIEW 
#define FLIP_PROJ_DIR_FOR_OPENXR 0//USE_EULER_ANGLES_FOR_XR_VIEW
