...
private:
	...
	void render_projection_layer_view(const XrCompositionLayerProjectionView& projection_layer_view, const XrSwapchainImageBaseHeader* swapchain_image, int64_t swapchain_format, int view_id, int input_image_index, VkCommandBuffer command_buffer, VkExtent2D input_extent, bool waterwarp);
